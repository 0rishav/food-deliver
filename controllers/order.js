...
//This is for what you want to order:----
...
export const placeOrder = asyncError ( async (req, res, next) => {
    ...
    res.status(201).json({
        success : true,
        message : "Order Placed Successfully By Cash On Delivery",
    });
});

//This is for Online payment method:------
